...
REVIEW: End any prepared draft with one short review note identifying what ${v.reviewer.toLowerCase()} should confirm. Never imply an actual reviewer has been assigned or notified. Nothing leaves the app. Do not request personal identifiers or sensitive client files in a public demo.
