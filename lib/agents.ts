...
function draftAgent(
  ...
  return {
    ...
    phase,
    status: 'live',
    oneLiner: `${role} specialist for ${kete}. Chat-ready, memory-aware, and coordinated through Iho.`,
    expertise: `${role} at senior operator level, with kete-specific legislation, live context, and evidence-pack discipline.`,
    collaboratesWith: ['iho', 'signal'],
    memoryScope: 'Tenant profile, prior decisions, workflow state, reviewer preferences, and relevant evidence-pack history.',
    ambientBrief: 'Prepare proactive draft suggestions, risks, and handoff notes for the operator briefing.',
    legislation: ['Privacy Act 2020', 'Relevant NZ industry guidance'],
