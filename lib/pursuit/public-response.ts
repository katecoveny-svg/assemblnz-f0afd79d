...
const errors=new Set(['research_provider_unavailable','research_protocol_error','research_search_limit','no_verified_search_result','research_output_too_large','research_invalid_json','research_ambiguous_json','storage_unavailable','receipt_not_saved','untraced_outreach_source','untraced_source','seller_website_mismatch','duplicate_outreach_account']);
