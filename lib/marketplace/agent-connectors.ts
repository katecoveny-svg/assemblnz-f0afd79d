...
export const TOOL_ACTION_CATALOGUE: AgentToolAction[] = [
  ...
  },
  {
    id: 'create_lead',
    name: 'create lead',
    description: 'captures a name, need and contact into your pipeline — via your own connected CRM.',
  ...
  },
  {
    id: 'add_sheet_row',
    name: 'add to sheet',
    description: 'appends a row to a spreadsheet you choose — via your own connected Google account.',
