...
export const KETES: Kete[] = [
  ...
  },
  {
    ...
    industry: 'Logistics',
    tagline: 'Import entries, tariff notes and broker evidence — drafted for a licensed broker to check.',
    accent: '#255F94',
  ...
  },
  {
    ...
    industry: 'Creative',
    tagline: 'Claim-safe brand drafts — ASA and Fair Trading checks before you approve.',
    accent: '#5B4FA0',
  ...
  },
  {
    ...
    industry: 'Family',
    tagline: 'School notices, money, routines and the week ahead — drafted for a parent to approve.',
    accent: '#23211F',
    accentName: 'Mangū',
    type: 'whanau',
    status: 'active',
