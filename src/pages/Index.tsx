...
const PRICING = [
  {
    ...
    features: ["1 industry kete (your pick)", "\n", "\n", "\n"],
    highlight: true,
    accent: C.pounamu,
  ...
  },
  {
    ...
    desc: "Multi-discipline SMEs. Two kete.",
    features: ["2 industry kete", "\n", "", "\n"],
    highlight: false,
  ...
  },
  {
    ...
    desc: "Multi-site, regulated, high-stakes. All five kete.",
    features: ["All 5 industry kete", "", "\n", "\n", "\n"],
    highlight: false,
    accent: C.navy,
