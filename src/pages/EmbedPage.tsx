...
import { ArrowLeft, Copy, Check, MessageCircle, Zap, Users, BarChart3 } from "lucide-react";
          ...
          <div className="rounded-xl border border-border bg-card overflow-hidden">
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b border-border">
              ...
              <div className="flex-1 text-center">
                <span className="text-xs text-muted-foreground font-mono-jb">yourwebsite.co.nz</span>
              </div>
            </div>
            {/* Fake website content */}
            <div className="p-8 sm:p-12 min-h-[300px] relative" style={{ background: "linear-gradient(135deg, hsl(var(--card)), hsl(var(--background)))" }}>
        ...
        <div className="max-w-2xl mx-auto mb-16">
          ...
          <div className="relative rounded-xl border border-border bg-card overflow-hidden">
            <div className="flex items-center justify-between px-4 py-2 border-b border-border">
              <span className="text-xs text-muted-foreground font-mono-jb">HTML</span>
              <button
                onClick={handleCopy}
