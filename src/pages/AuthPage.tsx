        ...
        <div className="w-full max-w-sm">
          <div className="text-center mb-8 opacity-0 animate-fade-up" style={{ animationFillMode: "forwards" }}>
            <Link to="/" className="inline-flex items-center gap-3 mb-6">
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, letterSpacing: "3px", textTransform: "lowercase", fontSize: "15px", background: "linear-gradient(90deg, #FFFFFF 0%, #FFFFFF 48%, #4AA5A8 72%, #3A7D6E 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>assembl</span>
            </Link>
