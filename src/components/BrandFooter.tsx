...
const FOOTER_LINKS = {
  ...
  "Industry Packs": [
    ...
    { to: "/packs/hanga", label: "Hanga — Construction" },
    { to: "/packs/auaha", label: "Auaha — Creative" },
    { to: "/packs/pakihi", label: "Pakihi — Business Ops" },
    { to: "/packs/hangarau", label: "Hangarau — Technology" },
  ],
  Company: [
