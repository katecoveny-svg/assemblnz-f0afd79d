...
import {
  ...
  Shield, Lock, Heart, PenTool, Users, UtensilsCrossed, Mic
} from "lucide-react";
...
const PACK_SUGGESTIONS: Record<string, string[]> = {
  ...
  manaaki: [
    ...
    "Alcohol licence status",
    "Staff training gaps",
    "Audit preparation checklist",
    "Allergen management plan",
    "Generate food control plan",
  ],
  pakihi: [
    "Employment cost calculator",
    "Draft employment agreement",
    "Leave entitlements check",
    "Disciplinary process guide",
    "Personal grievance timeline",
...
const PACK_TITLES: Record<string, string> = {
  hanga: "Hanga Intelligence",
  manaaki: "Manaaki Intelligence",
  pakihi: "Pakihi Intelligence",
  auaha: "Auaha Intelligence",
  hangarau: "Hangarau Intelligence",
};
...
export default function PackChatPanel({ packId = "hanga" }: PackChatPanelProps) {
  ...
  const suggestions = PACK_SUGGESTIONS[packId] || PACK_SUGGESTIONS.hanga;
  const title = PACK_TITLES[packId] || "Assembl Intelligence";
            ...
            <div className="px-3 pb-3 pt-1">
              ...
              >
                <input
                  ...
                  placeholder="Ask about safety, projects, compliance..."
