...
const FEATURED = [
  ...
  { name: "VAULT", color: "#1A3A5C", id: "finance", title: "Mortgage Comparison", desc: "Compare banks and find the cheapest option", Preview: VaultMortgagePreview },
  { name: "SHIELD", color: "#1A3A5C", id: "insurance", title: "Risk Assessment", desc: "Natural hazard profile and recommended sum insured", Preview: ShieldRiskPreview },
