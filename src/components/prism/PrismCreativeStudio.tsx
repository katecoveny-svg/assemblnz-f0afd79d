...
export default function PrismCreativeStudio({ onSendToChat }: { onSendToChat?: (msg: string) => void }) {
  ...
  const generate = () => {
    ...
    const brandSection = brandPreset === "assembl"
      ? "Use Assembl brand: #09090F background, #00FF88/#00E5FF/#FF2D9B accents, Syne + JetBrains Mono fonts."
...
${imageTags}${qualityTag}`
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-3">
      <h2 className="text-sm font-syne font-bold" style={{ color: "#E4E4EC" }}>Image Studio</h2>
      <p className="text-[11px] font-jakarta" style={{ color: "rgba(255,255,255,0.4)" }}>Generate professional visuals with guided controls.</p>
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-[10px] font-jakarta" style={{ color: "rgba(255,255,255,0.5)" }}>Include text overlay</span>
      </div>
      {includeText && (
