...
const FAQS = [
  ...
  { q: "Can I try before I buy?", a: "We start with a 30-minute discovery call to map your workflows and agree what success looks like before you sign anything. Then a 10-business-day setup with kickoff, data import, brand kit, and pilot. If we miss the 10-day window we refund the setup fee." },
