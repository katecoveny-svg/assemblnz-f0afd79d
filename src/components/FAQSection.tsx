...
const FAQS = [
  ...
  { q: "Can I try before I buy?", a: "Absolutely. Every specialist tool offers free messages with no signup required. You can explore all 45 tools before choosing a plan. Powered by specialist intelligence trained on NZ law." },
