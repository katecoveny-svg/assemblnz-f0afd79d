...
const FAQS = [
  { q: "What is Assembl?", a: "Assembl is an AI platform built in Aotearoa for the way New Zealand businesses actually operate. We bundle live-updated NZ law, tikanga-governed workflows, and industry-specific specialist agents into evidence packs you can hand to a regulator, a client, or a board. Seven industry kete cover Manaaki (hospitality), Waihanga (construction), Auaha (creative), Arataki (automotive & fleet), Pikau (freight & customs), Hoko (retail), and Ako (early childhood). Tōro is the consumer kete for whānau running family admin." },
  { q: "How is this different from ChatGPT?", a: "ChatGPT gives generic answers from global training data and confidently gets NZ law wrong. Assembl is grounded in current NZ Acts, regulator guidance, and policy workflows, with a tikanga governance posture and an audit trail on every output. Every answer cites the Act, regulator, or record it draws from — and lands in an evidence pack, not a chat bubble." },
  { q: "How does Assembl fit with NZ-owned AI infrastructure?", a: "Sovereign infrastructure providers (like Kererū) answer where your data lives. Assembl answers what your data does — the product layer of NZ-grounded agents, compliance pipeline, and evidence packs. We're exploring relationships with NZ-owned infrastructure partners and will say more when terms are signed. NZ businesses need both layers." },
  { q: "Where is my data hosted?", a: "We're exploring relationships with NZ-owned infrastructure partners so more of your data can stay on NZ soil over time. Sovereign hosting is in flight — not yet live for every customer. Ask us where your specific kete runs and we'll tell you the truth, including which workloads still touch overseas hyperscalers." },
  ...
  { q: "Is my data safe?", a: "All data is encrypted in transit and at rest. We follow NZISM guidance, align to AAAIP and the NZ Privacy Act 2020, and your business data is never used to train models. Attested NZ data residency is rolling out as we formalise NZ-owned infrastructure partnerships — ask us about your specific workload." },
