...
const INTENT_MAP: IntentKeywordMap[] = [
  ...
  { category: 'marketing', keywords: ['marketing', 'seo', 'email campaign', 'newsletter', 'audience', 'funnel', 'leads', 'conversion', 'ads', 'promotion'], keteIds: ['auaha', 'pakihi'] },
  { category: 'finance', keywords: ['payroll', 'invoice', 'tax', 'gst', 'acc', 'budget', 'cashflow', 'accounting', 'profit', 'loss', 'expense', 'revenue'], keteIds: ['pakihi'] },
  { category: 'hr', keywords: ['hire', 'recruit', 'staff', 'employee', 'onboard', 'payroll', 'leave', 'kiwisaver', 'employment', 'contract', 'performance review'], keteIds: ['pakihi'] },
  { category: 'legal', keywords: ['contract', 'agreement', 'terms', 'compliance', 'regulation', 'act', 'legislation', 'legal', 'dispute', 'liability'], keteIds: ['pakihi'] },
  { category: 'compliance', keywords: ['health and safety', 'h&s', 'worksafe', 'audit', 'inspection', 'certification', 'resource consent', 'building consent', 'rma'], keteIds: ['hanga', 'pakihi'] },
  ...
  { category: 'transport', keywords: ['vehicle', 'fleet', 'truck', 'ship', 'freight', 'logistics', 'maritime', 'ais', 'route', 'delivery', 'transport'], keteIds: ['waka'] },
  { category: 'tech', keywords: ['code', 'app', 'software', 'api', 'database', 'server', 'deploy', 'devops', 'security', 'cyber', 'network', 'cloud'], keteIds: ['hangarau'] },
  ...
  { category: 'property', keywords: ['property', 'rental', 'tenant', 'landlord', 'maintenance', 'lease', 'bond', 'inspection'], keteIds: ['pakihi'] },
  { category: 'health', keywords: ['fitness', 'sport', 'health', 'wellbeing', 'exercise', 'travel', 'trip', 'holiday', 'itinerary'], keteIds: ['hauora'] },
  { category: 'sales', keywords: ['sales', 'crm', 'pipeline', 'deal', 'quote', 'proposal', 'lead', 'prospect', 'client'], keteIds: ['pakihi'] },
  { category: 'maori', keywords: ['te reo', 'māori', 'maori', 'tikanga', 'iwi', 'hapū', 'hapu', 'whakapapa', 'kaupapa', 'whenua'], keteIds: ['te-kahui-reo'] },
  { category: 'care', keywords: ['elderly', 'senior', 'caregiver', 'aged care', 'check-in', 'medication', 'wellbeing'], keteIds: ['hauora'] },
  { category: 'operations', keywords: ['workflow', 'automation', 'process', 'efficiency', 'operations', 'integrate', 'system'], keteIds: ['hangarau', 'pakihi'] },
  { category: 'education', keywords: ['teach', 'learn', 'course', 'training', 'workshop', 'curriculum'], keteIds: ['te-kahui-reo'] },
];
...
const KETE_META: Record<string, { name: string; accent: string }> = {
  'manaaki': { name: 'MANAAKI', accent: '#E8A87C' },
  'hanga': { name: 'HANGA', accent: '#C9B458' },
  'auaha': { name: 'AUAHA', accent: '#B794F4' },
  'pakihi': { name: 'PAKIHI', accent: '#D4A843' },
  'waka': { name: 'WAKA', accent: '#6B8FA3' },
  'hangarau': { name: 'HANGARAU', accent: '#3A7D6E' },
  'te-kahui-reo': { name: 'TE KĀHUI REO', accent: '#D4A843' },
  'toroa': { name: 'TŌROA', accent: '#E8D5B7' },
  'hauora': { name: 'HAUORA', accent: '#7BC8A4' },
