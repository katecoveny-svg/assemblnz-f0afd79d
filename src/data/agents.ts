...
export const echoAgent: Agent = {
  ...
  tagline: "Your AI Executive Assistant — answers calls, qualifies leads, manages email, schedules meetings, and creates world-class content",
  color: "#E4A0FF",
  sector: "Founder",
...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    name: "CLINIC",
    designation: "ASM-045",
    role: "Your Dental & Veterinary Practice Advisor",
    tagline: "Practice management intelligence for dental and veterinary clinics — compliance, scheduling, patient management, ACC claims",
    color: "#7E57C2",
    sector: "Health & Wellbeing",
  ...
  },
  {
    ...
    name: "PRISTINE",
    designation: "ASM-046",
    role: "Your Commercial Cleaning Operations Advisor",
    tagline: "Quoting, scheduling, staff management, chemical compliance, and contract management for cleaning businesses",
    color: "#26C6DA",
    sector: "Business Tools",
  ...
  },
  {
    ...
    name: "NETWORK",
    designation: "ASM-047",
    role: "Your Franchise Operations Strategist",
    tagline: "Franchise agreements, disclosure documents, operations manuals, network management, and benchmarking",
    color: "#FF7043",
    sector: "Business Tools",
