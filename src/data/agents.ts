...
export const echoAgent: Agent = {
  ...
  name: "ECHO",
  designation: "ASM-000",
  role: "Your Front Desk That Never Sleeps",
  tagline: "Handles customer enquiries, answers FAQs, routes complex questions, captures leads, creates content, and manages social media — trained on your business, available 24/7",
  color: "#E4A0FF",
  sector: "Founder",
