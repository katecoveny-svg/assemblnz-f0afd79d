...
export const OUTPUT_CARDS: OutputCard[] = [
  // ECHO
  {
    ...
    preview: `**Slide 1 (Hook):**\nYour business runs on seven different platforms.\nAssembl runs on seven industry kete + Tōro.\n\n**Slide 2:**\nKete handle the workflows that drain your team…`,
    fullContent: `**Slide 1 (Hook):**\nYour business runs on seven different platforms.\nAssembl runs on seven industry kete + Tōro.\n\n**Slide 2:**\nKete handle the workflows that drain your team — payroll, compliance, scheduling, contracts, customer comms.\n\n**Slide 3:**\nGrounded in NZ legislation and policy workflows. Updated when the law changes.\n\n**Slide 4:**\nManaaki, Waihanga, Auaha, Arataki, Pikau, Hoko, Ako — plus Tōro for whānau. Seven industry kete + Tōro, one platform.\n\n**Slide 5 (CTA):**\nSeven industry kete + Tōro. Built in Aotearoa.\n→ assembl.co.nz\n\n**Caption:** Specialist operational workflows for NZ business. Seven industry kete + Tōro grounded in NZ legislation. From NZ$590/mo. Link in bio.\n\n#NZBusiness #Assembl #SmallBusinessNZ #BusinessAutomation #BuiltInAotearoa`,
  },
  {
    id: "echo-linkedin",
    agentId: "echo",
