...
const AdminMcpAmbient = lazy(() => import("./pages/admin/mcp/AmbientLoop"));
                  ...
                  <BusinessProvider>
                    ...
                    <div className="pb-14 sm:pb-0 relative z-10">
                      ...
                      <Routes>
                        ...
                        <Route path="/chat/toro/*" element={<Navigate to="/toro/app" replace />} />
                        <Route path="/toroa" element={<Navigate to="/toro/app" replace />} />
                        <Route path="/toroa/*" element={<Navigate to="/toro/app" replace />} />
                        ...
                        <Route path="/admin/mcp" element={<Suspense fallback={null}><AdminMcpLayout /></Suspense>}>
                          ...
                          <Route path="ambient" element={<Suspense fallback={null}><AdminMcpAmbient /></Suspense>} />
                        </Route>
                       ...
                       <Route path="/toro/journal" element={<Suspense fallback={null}><ToroJournal /></Suspense>} />
                        ...
                        <Route path="/toro/logistics" element={<Suspense fallback={null}><ToroLogistics /></Suspense>} />
