        ...
        <div className="mx-auto max-w-[1180px]">
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-3">
            {content.pains.map((pain) => (
              <article key={pain} className="rounded-[8px] border border-[#C8BBA9]/70 bg-[#FFF7EC]/78 p-5">
      ...
      <div className="mt-5 grid gap-4">
        {items.map((item) => (
          <Link
            key={item.href}
            href={item.href}
            className="group rounded-[8px] border border-[#C8BBA9]/70 bg-white/62 p-5 transition hover:-translate-y-1 hover:border-[#3A3832] hover:bg-white"
          >
