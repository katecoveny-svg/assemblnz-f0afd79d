...
export function FluxConnections({ leads }: { leads: Lead[] }) {
  ...
  return <section className="sp-paper sp-connections" id="flux-connections">
    ...
    <p>Connect your business account, inspect the exact fields, then request an assembl operator’s review. Once your operator enables approved actions, Salesforce can create the reviewed lead and Outlook can create an unsent draft for you to review in your mailbox.</p>
