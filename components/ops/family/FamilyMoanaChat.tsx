    ...
    >
      <div className="flex items-center gap-3 border-b border-black/5 px-4 py-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-[12px]" style={{ color: '#68766f' }}>tides · weather · safety · draft-only</p>
        </div>
        <span className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[12px] font-medium" style={{ background: `${BLUE}18`, color: INK }}>
