...
export function PainfulWorkflowCapture() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="overflow-hidden rounded-[8px] border border-[rgba(35,33,31,0.12)] bg-[#FAF7F2] shadow-[0_22px_70px_rgba(35,33,31,0.08)]"
    >
      <div className="grid gap-8 p-5 md:grid-cols-[0.86fr_1.14fr] md:p-7">
        ...
        <div className="grid gap-3">
          ...
          <button
            ...
            className="mt-2 inline-flex h-12 w-fit items-center justify-center rounded-[8px] bg-[color:var(--assembl-pounamu)] px-6 font-mono text-[10px] uppercase tracking-[0.14em] text-[#FAF7F2] transition hover:-translate-y-0.5 hover:shadow-[0_18px_44px_rgba(43,107,87,0.26)] disabled:cursor-wait disabled:opacity-70"
          >
            {state === "loading" ? (
