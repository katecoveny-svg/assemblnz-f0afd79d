...
export function InstallPwaButton({ label = "Save to home screen", compact = false }: InstallPwaButtonProps) {
  ...
  if (installed) {
    return (
      <span className="inline-flex min-h-10 items-center gap-2 rounded-full border border-white/60 bg-white/42 px-4 text-sm text-[#103F35] shadow-[inset_0_1px_0_rgba(255,255,255,0.74)] backdrop-blur-md">
