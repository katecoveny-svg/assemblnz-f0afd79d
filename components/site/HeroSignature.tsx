...
export function HeroSignature({
  ...
  return (
    <div className={`inline-flex flex-wrap items-center gap-3 ${className}`}>
      <span className="rounded-full border border-[rgba(43,107,87,0.22)] bg-white/45 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.18em] text-[color:var(--assembl-pounamu)]">
        {eyebrow}
      </span>
