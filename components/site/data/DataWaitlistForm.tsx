        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4" noValidate>
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-2 w-full rounded-[8px] border border-[rgba(35,33,31,0.16)] bg-[#FFF7EC] px-4 py-3 text-sm text-[color:var(--text-primary)] placeholder:text-[color:var(--text-secondary)]/70 focus-visible:border-[color:var(--assembl-pounamu)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--assembl-pounamu)]/30 focus:outline-none"
            />
          </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full bg-[color:var(--assembl-pounamu)] px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-[color:var(--assembl-pounamu-deep)] focus-visible:bg-[color:var(--assembl-pounamu-deep)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--assembl-pounamu)] focus-visible:ring-offset-2 disabled:opacity-60"
          >
  ...
  return (
    <div>
      <label htmlFor={id} className="block font-mono text-[11px] uppercase tracking-[0.14em] text-[color:var(--text-secondary)]">
        {label}
        {required && (
          <span className="ml-1 text-[color:var(--assembl-pounamu)] font-bold" aria-hidden="true">
            *
          </span>
        )}
      </label>
