        ...
        {(['api-key', 'talk-to-kate'] as const).map((value) => {
          ...
          return (
            <button
              ...
              className={`rounded-full px-4 py-2 font-mono text-[11px] uppercase tracking-[0.14em] transition-all hover:opacity-90 hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--assembl-pounamu)]/40 focus-visible:ring-offset-2 focus-visible:-translate-y-0.5 active:translate-y-0 ${
                active
                  ? 'bg-[color:var(--assembl-pounamu)] text-white shadow-sm'
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4" noValidate>
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-2 w-full rounded-[8px] border border-[rgba(35,33,31,0.16)] bg-[#FFF7EC] px-4 py-3 text-sm text-[color:var(--text-primary)] placeholder:text-[color:var(--text-secondary)]/70 focus-visible:border-[color:var(--assembl-pounamu)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--assembl-pounamu)]/30 focus-visible:ring-offset-2 transition-all"
            />
          </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full bg-[color:var(--assembl-pounamu)] px-6 py-3 text-sm font-medium text-white transition-all hover:bg-[color:var(--assembl-pounamu-deep)] hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--assembl-pounamu)] focus-visible:ring-offset-2 focus-visible:-translate-y-0.5 active:translate-y-0 disabled:opacity-60"
          >
