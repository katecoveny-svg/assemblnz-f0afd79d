  ...
  if (href) {
    return (
      <a
        ...
        className={cn(
          baseClasses,
          'hover:bg-white/80 hover:text-[color:var(--text-primary)] hover:shadow-sm focus-visible:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--assembl-pounamu)] focus-visible:outline-offset-2',
        )}
