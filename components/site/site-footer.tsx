...
import { isAdminHub, isAgentMarketplace, isAlphassembl, isAssemblBills, isAtlas, isAuthSurface, isCustomerWorkspace, isDashMicrosite, isEcho, isStandaloneHealth, isStudio } from "@/components/site/site-header";
...
export function SiteFooter() {
  ...
  if (isDashMicrosite(pathname) || isAgentMarketplace(pathname) || isAtlas(pathname) || isEcho(pathname) || isAuthSurface(pathname) || isAdminHub(pathname) || isCustomerWorkspace(pathname) || isAlphassembl(pathname) || isAssemblBills(pathname) || isStandaloneHealth(pathname) || isStudio(pathname) || pathname === "/") return null;
