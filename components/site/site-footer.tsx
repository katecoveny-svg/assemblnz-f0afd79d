...
import { isAdminHub, isAgentMarketplace, isAlphassembl, isAssemblBills, isAtlas, isAuthSurface, isCustomerWorkspace, isDashMicrosite, isEcho, isStandaloneHealth } from "@/components/site/site-header";
