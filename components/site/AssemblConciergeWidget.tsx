...
import { isCustomerWorkspace, isAlphassembl, isAssemblBills, isStandaloneHealth, isMotionStudio } from '@/components/site/site-header';
...
export function AssemblConciergeWidget() {
  ...
  if (isAgentChatPage || isAdminHub || isTenantWorkspace || isAlphassembl(pathname) || isAssemblBills(pathname) || isStandaloneHealth(pathname) || isMotionStudio(pathname) || pathname === '/') {
    return null;
  }
