    ...
    <aside className="fixed bottom-4 right-4 z-40 flex flex-col items-end gap-3 md:bottom-6 md:right-6">
      {open ? (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="assembl-guide-title"
          className="w-[min(calc(100vw-2rem),390px)] animate-in fade-in zoom-in-95 slide-in-from-bottom-2 overflow-hidden rounded-[8px] border border-[rgba(35,33,31,0.14)] bg-[color:var(--assembl-paper)] shadow-[0_24px_80px_rgba(35,33,31,0.22)]"
        >
            ...
            >
              ...
              <div className="relative flex-1">
                <input
                  ...
                  className="h-11 w-full rounded-[8px] border border-[rgba(35,33,31,0.14)] bg-white/70 px-3 pr-16 text-sm text-[color:var(--text-primary)] outline-none transition-all focus:border-[color:var(--assembl-pounamu)] focus:ring-2 focus:ring-[color:var(--assembl-pounamu)]/20"
                />
                <div
                  id="assembl-guide-counter"
                  className="absolute right-3 top-1/2 -translate-y-1/2 font-mono text-[9px] uppercase tracking-[0.1em] text-[color:var(--text-secondary)]"
                >
