...
import { isCustomerWorkspace, isAlphassembl, isAssemblBills, isStandaloneHealth } from '@/components/site/site-header';
...
export function AssemblConciergeWidget() {
  ...
  if (isAgentChatPage || isAdminHub || isTenantWorkspace || isAlphassembl(pathname) || isAssemblBills(pathname) || isStandaloneHealth(pathname) || pathname === '/') {
    return null;
  }
