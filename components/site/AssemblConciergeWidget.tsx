        ...
        >
          <div className="flex items-start justify-between gap-4 border-b border-[rgba(35,33,31,0.10)] bg-white/60 p-4">
            ...
            <button
              ...
              className="rounded-full p-2 text-[color:var(--text-secondary)] transition-all hover:bg-[rgba(35,33,31,0.06)] hover:text-[color:var(--text-primary)] focus-visible:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--assembl-pounamu)] focus-visible:outline-offset-2"
            >
          ...
          <div className="border-t border-[rgba(35,33,31,0.10)] p-4">
            <div className="mb-3 flex flex-wrap gap-2">
              {QUICK_PROMPTS.map((prompt) => (
                <button
                  ...
                  onClick={() => send(prompt)}
                  disabled={isTyping}
                  className="rounded-full border border-[rgba(35,33,31,0.12)] bg-white/60 px-3 py-1 text-xs text-[color:var(--text-secondary)] transition-all hover:-translate-y-0.5 hover:border-[color:var(--assembl-pounamu)] hover:text-[color:var(--text-primary)] focus-visible:-translate-y-0.5 focus-visible:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--assembl-pounamu)] focus-visible:outline-offset-2 disabled:opacity-40"
                >
                  {prompt}
                </button>
              ))}
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="h-11 min-w-0 flex-1 rounded-[8px] border border-[rgba(35,33,31,0.14)] bg-white/70 px-3 text-sm text-[color:var(--text-primary)] transition-all focus:border-[color:var(--assembl-pounamu)] focus:outline focus:outline-2 focus:outline-[color:var(--assembl-pounamu)] focus:outline-offset-2 disabled:opacity-60"
                />
                <button
                  type="submit"
                  aria-label="Send"
                  className="inline-flex h-11 w-11 items-center justify-center rounded-[8px] bg-[color:var(--assembl-pounamu)] text-[color:var(--assembl-paper)] transition-all hover:opacity-90 focus-visible:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--assembl-pounamu)] focus-visible:outline-offset-2 disabled:opacity-40"
            ...
            <Link
              ...
              className="mt-1 inline-flex items-center rounded-sm font-mono text-[10px] uppercase tracking-[0.18em] text-[color:var(--assembl-pounamu)] transition-opacity hover:opacity-80 focus-visible:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--assembl-pounamu)] focus-visible:outline-offset-2"
            >
              {latestMatch.cta}
