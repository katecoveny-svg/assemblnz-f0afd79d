    ...
    >
      <div className="border-l-4 p-5" style={{ borderColor: accent }}>
        <div className="flex items-start justify-between gap-5">
          ...
          <div className="rounded-full border px-3 py-1 font-mono text-[12px] uppercase tracking-[0.14em]" style={{ borderColor: `${accent}55`, color: accent }}>
            {statusLabel}
          </div>
        </div>
        ...
        <dl className="grid gap-3 text-sm text-[color:var(--text-body)] sm:grid-cols-3">
          <div>
            <dt className="font-mono text-[12px] uppercase tracking-[0.16em] text-[color:var(--text-secondary)]">Record ID</dt>
            <dd className="mt-1">{workflowId}</dd>
          </div>
          <div>
            <dt className="font-mono text-[12px] uppercase tracking-[0.16em] text-[color:var(--text-secondary)]">Reviewer</dt>
            <dd className="mt-1">{reviewer}</dd>
          </div>
          <div>
            <dt className="font-mono text-[12px] uppercase tracking-[0.16em] text-[color:var(--text-secondary)]">Timestamp</dt>
