  ...
  return (
    ...
    >
      <Link
        ...
        className={`kete-card group relative block h-full overflow-hidden rounded-card border border-[rgba(35,33,31,0.08)] bg-white/55 backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 hover:scale-[1.02] hover:border-[rgba(35,33,31,0.18)] hover:shadow-[0_24px_56px_rgba(58,56,50,0.14)] focus-visible:-translate-y-0.5 focus-visible:scale-[1.02] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[color:var(--assembl-pounamu)] focus-visible:outline-offset-2 active:translate-y-0 active:scale-100 ${
