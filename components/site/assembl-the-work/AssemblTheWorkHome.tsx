...
export function AssemblTheWorkHome({preview=false}:{preview?:boolean}){return <div className="atw atw-spatial atw-immersive" data-preview={preview}>
 <a className="atw-skip" href="#try-pursuit">Skip to the research canvas</a>
