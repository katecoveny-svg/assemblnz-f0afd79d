...
export function AssemblTheWorkHome({ preview = false }: { preview?: boolean }) {
  return <div className="atw atw-spatial" data-preview={preview}>
    ...
    <section className="atw-companion-story" aria-labelledby="companion-story-title">
      <div className="atw-companion-copy"><p className="atw-kicker">DO / PUBLIC FACE</p><h2 id="companion-story-title">Two tools.<br />Useful work.</h2><p>Public DO is pared to Meeting notes and a generic Household chores board. Drafts only — nothing is sent for you.</p>
        <article><span>01 / MEETING</span><h3>Capture → useful notes.</h3><p>Record or paste. Transcribe when Deepgram is configured. Review actions, decisions and attendees before any handoff.</p><Link className="atw-text-link" href="/do/meetings">Open Meeting DO <ArrowUpRight size={17} /></Link></article>
        <article><span>02 / HOUSEHOLD</span><h3>Demo chores board.</h3><p>Install the scrubbed public Household template. Owner-private family context stays closed on the public site.</p><Link className="atw-text-link" href="/do/household">Open Household DO <ArrowUpRight size={17} /></Link></article>
        <article><span>03 / YOUR DOS</span><h3>One honest shelf.</h3><p>The public /do page lists only these two. Glow opens the same pair — not operator task lists or specialist Builder shelves.</p><Link className="atw-text-link" href="/do#your-dos">See public DO <ArrowUpRight size={17} /></Link></article>
