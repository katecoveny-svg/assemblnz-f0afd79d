...
export function AssemblTheWorkHome({ preview = false }: { preview?: boolean }) {
  return <div className="atw atw-spatial" data-preview={preview}>
    ...
    <section className="atw-product-strip" aria-label="Three products, one system"><a href="https://assembl-pursuit.katecoveny.chatgpt.site" target="_blank" rel="noopener noreferrer"><strong>Pursuit</strong><span>— <em>find it.</em></span></a><Link href="/do"><strong>DO</strong><span>— <em>do it.</em></span></Link><Link href="/creative-studio"><strong>Studio</strong><span>— <em>show it.</em></span></Link><p>{HERO.loopLine}</p></section>
    <section className="atw-companion-story" aria-labelledby="companion-story-title">
      <div className="atw-companion-copy">
        <p className="atw-kicker">DO / PUBLIC FACE</p>
        <h2 id="companion-story-title">A little DO.<br /><em>Useful work.</em></h2>
        <p>Public DO is Meeting notes and a generic Household chores board — plum and dusty rose, drafts only. Nothing is sent for you.</p>
        <article>
          <span>01 / MEETING</span>
          <h3>Capture → useful notes.</h3>
          <p>Record or paste. Transcribe when Deepgram is configured. Review actions, decisions and attendees before any handoff.</p>
          <Link className="atw-text-link" href="/do/meetings">Open Meeting DO <ArrowUpRight size={17} /></Link>
        </article>
        <article>
          <span>02 / HOUSEHOLD</span>
          <h3>Demo chores board.</h3>
          <p>Install the scrubbed public Household template. Owner-private family context stays closed on the public site.</p>
          <Link className="atw-text-link" href="/do/household">Open Household DO <ArrowUpRight size={17} /></Link>
        </article>
        <article>
          <span>03 / YOUR DOS</span>
          <h3>One honest shelf.</h3>
          <p>The public /do page lists only Meeting DO and Household DO — not operator shelves or a broken maker.</p>
          <Link className="atw-text-link" href="/do#your-dos">See public DO <ArrowUpRight size={17} /></Link>
        </article>
      </div>
      <div className="atw-companion-scene"><DoSpatialScene /></div>
    </section>
    ...
    <footer className="atw-footer"><Link className="atw-wordmark" href="/">assembl</Link><p>Find it. DO it. Show it.<br />Built in New Zealand.</p><nav aria-label="Footer"><a href="https://assembl-pursuit.katecoveny.chatgpt.site" target="_blank" rel="noopener noreferrer">Pursuit</a><Link href="/do">DO</Link><Link href="/creative-studio">Studio</Link><Link href="/contact">Contact</Link><Link href="/legal/privacy">Privacy</Link></nav><span>One shared context · portable agents · proof that compounds.</span></footer>
  </div>;
}
