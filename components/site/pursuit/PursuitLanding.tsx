...
export function PursuitLanding() {
  ...
  return <div className={`atw pursuit-dimensional ${styles.page}`} data-paused={paused||undefined}>
    ...
    <section className={styles.hero} aria-labelledby="pursuit-title"><div className={styles.ambient} aria-hidden="true" /><header className={styles.header}><Link href="/" className={styles.wordmark}>assembl</Link><nav aria-label="Primary"><Link href="/pursuit" aria-current="page">Pursuit</Link><Link href="/do">DO</Link><Link href="/creative-studio" >Studio</Link></nav></header>
      <div className={styles.heroGrid}><div className={styles.heroCopy}><p className={styles.eyebrow}>Pursuit / find it.</p><h1 id="pursuit-title">Find the opening.<br /><span className="fluid-text">Make it worth a conversation.</span></h1><p className={styles.lead}>Start with your website. Find relevant businesses, research a reason to talk and prepare outreach you can review.</p><a className={styles.primary} href="#website-outreach">Find my next openings <ArrowRight size={19} /></a><a className={styles.quietLink} href={hub} target="_blank" rel="noopener noreferrer">Open private client hubs <ArrowUpRight size={16} /></a><p className={styles.honesty}>The research trial checks its availability below. Private client work remains in the existing authenticated Pursuit hubs.</p></div>
