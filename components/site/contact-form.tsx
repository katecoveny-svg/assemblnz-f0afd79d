      ...
      <div className="grid gap-5">
        ...
        <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            type="submit"
            disabled={isPending}
            className="inline-flex h-12 items-center bg-[#252d31] px-7 font-mono text-xs uppercase tracking-[0.12em] text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#1c2225] hover:shadow-soft focus-visible:-translate-y-0.5 focus-visible:bg-[#1c2225] focus-visible:shadow-soft focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-2 active:translate-y-0 active:scale-[0.98] disabled:opacity-60 disabled:pointer-events-none"
          >
            {isPending ? (
              <>
