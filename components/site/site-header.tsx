      ...
      <div className="container flex h-16 items-center justify-between gap-6">
        <div className="flex min-w-0 items-baseline gap-3">
          <Link
            ...
            className="shrink-0 rounded-sm font-display text-2xl font-semibold lowercase tracking-tight text-[color:var(--text-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--assembl-pounamu)] focus-visible:ring-offset-2"
          >
            assembl
          </Link>
