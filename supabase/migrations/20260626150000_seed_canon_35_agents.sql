-- Seed — live agent roster (35 agents).
--
...
DELETE FROM public.agent_installs WHERE agent_slug NOT IN ('atlas', '9am-brief', 'fridge-to-list', 'panui-parser', 'whanau-help', 'school-notice', 'care-captain', 'invoice-tidy', 'hui-notes', 'roster-sorter', 'inbox-triage', 'travel-logs', 'tax-tidy', 'meeting-records', 'power-watch', 'arataki', 'customs-entry', 'food-temp-logs', 'stock-count', 'compliance-check', 'building-consent', 'maritime-brief', 'tide-weather', 'catch-log', 'care-scribe', 'voice-cs', 'auaha', 'social-manager', 'chief', 'roster', 'counter', 'pilot', 'echo', 'prism', 'aroha');
DELETE FROM public.agent_chat_sessions WHERE agent_slug NOT IN ('atlas', '9am-brief', 'fridge-to-list', 'panui-parser', 'whanau-help', 'school-notice', 'care-captain', 'invoice-tidy', 'hui-notes', 'roster-sorter', 'inbox-triage', 'travel-logs', 'tax-tidy', 'meeting-records', 'power-watch', 'arataki', 'customs-entry', 'food-temp-logs', 'stock-count', 'compliance-check', 'building-consent', 'maritime-brief', 'tide-weather', 'catch-log', 'care-scribe', 'voice-cs', 'auaha', 'social-manager', 'chief', 'roster', 'counter', 'pilot', 'echo', 'prism', 'aroha');
DELETE FROM public.agents WHERE slug NOT IN ('atlas', '9am-brief', 'fridge-to-list', 'panui-parser', 'whanau-help', 'school-notice', 'care-captain', 'invoice-tidy', 'hui-notes', 'roster-sorter', 'inbox-triage', 'travel-logs', 'tax-tidy', 'meeting-records', 'power-watch', 'arataki', 'customs-entry', 'food-temp-logs', 'stock-count', 'compliance-check', 'building-consent', 'maritime-brief', 'tide-weather', 'catch-log', 'care-scribe', 'voice-cs', 'auaha', 'social-manager', 'chief', 'roster', 'counter', 'pilot', 'echo', 'prism', 'aroha');
