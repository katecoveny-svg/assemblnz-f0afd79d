-- Seed — LOCKED CANON 23-agent roster (2026-06-23).
--
...
DELETE FROM public.agent_installs WHERE agent_slug NOT IN ('9am-brief', 'fridge-to-list', 'panui-parser', 'whanau-help', 'school-notice', 'care-captain', 'invoice-tidy', 'hui-notes', 'roster-sorter', 'inbox-triage', 'travel-logs', 'tax-tidy', 'meeting-records', 'power-watch', 'customs-entry', 'food-temp-logs', 'stock-count', 'compliance-check', 'maritime-brief', 'tide-weather', 'catch-log', 'care-scribe', 'voice-cs');
DELETE FROM public.agent_chat_sessions WHERE agent_slug NOT IN ('9am-brief', 'fridge-to-list', 'panui-parser', 'whanau-help', 'school-notice', 'care-captain', 'invoice-tidy', 'hui-notes', 'roster-sorter', 'inbox-triage', 'travel-logs', 'tax-tidy', 'meeting-records', 'power-watch', 'customs-entry', 'food-temp-logs', 'stock-count', 'compliance-check', 'maritime-brief', 'tide-weather', 'catch-log', 'care-scribe', 'voice-cs');
DELETE FROM public.agents WHERE slug NOT IN ('9am-brief', 'fridge-to-list', 'panui-parser', 'whanau-help', 'school-notice', 'care-captain', 'invoice-tidy', 'hui-notes', 'roster-sorter', 'inbox-triage', 'travel-logs', 'tax-tidy', 'meeting-records', 'power-watch', 'customs-entry', 'food-temp-logs', 'stock-count', 'compliance-check', 'maritime-brief', 'tide-weather', 'catch-log', 'care-scribe', 'voice-cs');
