...
- `assembl-do-extension-1.5.2.zip` — Chrome / Edge Load unpacked
- `DO-mac-companion.zip` — Mac companion source (build on macOS; also aliased as `assembl-do-macos-1.5.2.zip`)
