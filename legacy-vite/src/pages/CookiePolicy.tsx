...
const CookiePolicy = () => (
  <div className="min-h-screen star-field flex flex-col relative">
    ...
    <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
      <h1 className="text-2xl sm:text-4xl font-display font-bold text-foreground mb-4">Cookie policy</h1>
      ...
      <div className="prose-sm space-y-6 text-sm text-foreground/80 leading-relaxed">
        <section>
          <h2 className="text-lg font-display font-bold text-foreground mb-2">1. What are cookies?</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-bold text-foreground mb-2">2. How we use cookies</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-bold text-foreground mb-2">3. Types of cookies we use</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-bold text-foreground mb-2">4. Local storage</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-bold text-foreground mb-2">5. Managing cookies</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-bold text-foreground mb-2">6. Updates</h2>
          <p>We may update this Cookie Policy as our use of cookies changes. Check this page for the latest information.</p>
        </section>

        <section>
          <h2 className="text-lg font-display font-bold text-foreground mb-2">7. Contact</h2>
          <p>Questions? Email <a href="mailto:assembl@assembl.co.nz" className="text-primary hover:underline">assembl@assembl.co.nz</a>.</p>
        </section>
      </div>
    </main>
    <BrandFooter />
