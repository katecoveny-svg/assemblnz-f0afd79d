  ...
  <div className="min-h-screen" style={{ background: C.bg, color: C.text }}>
    ...
    <section className="pt-32 pb-16 px-6 text-center">
      <div className="max-w-2xl mx-auto">
        <p className="text-[10px] tracking-[5px] uppercase mb-5" style={{ fontFamily: "'IBM Plex Mono', monospace", color: C.teal, fontWeight: 700 }}>
          — Operator-as-platform —
        </p>
        <h1 className="text-3xl sm:text-[44px] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, lineHeight: 1.15, color: C.text }}>
          You don't fit a pre-built industry kete.<br />
          <span style={{ color: C.teal }}>So buy the platform.</span>
        </h1>
        <p className="text-[16px] leading-[1.8] max-w-xl mx-auto mb-3" style={{ fontFamily: "'Inter', sans-serif", color: C.textSecondary }}>
        ...
        <p className="text-[12px]" style={{ fontFamily: "'IBM Plex Mono', monospace", color: C.textTertiary }}>
    ...
    <section className="px-6 pb-20">
      <div className="max-w-2xl mx-auto rounded-2xl p-8" style={{ background: "rgba(255,255,255,0.65)", border: "1px solid rgba(74,165,168,0.15)" }}>
        <h2 className="text-[18px] mb-6" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400, letterSpacing: "3px", textTransform: "uppercase", color: C.text }}>
          What's included
        </h2>
        <ul className="space-y-3">
          {FEATURES.map((f) => (
            <li key={f} className="flex items-start gap-3">
              ...
              <span className="text-[14px] leading-[1.7]" style={{ fontFamily: "'Inter', sans-serif", color: C.textSecondary }}>{f}</span>
            </li>
          ))}
        </ul>
      </div>
    ...
    <section className="px-6 pb-20">
      <div className="max-w-2xl mx-auto text-center">
        <p className="text-[14px] leading-[1.8] mb-6" style={{ fontFamily: "'Inter', sans-serif", color: C.textSecondary }}>
        ...
        <p className="text-[13px]" style={{ fontFamily: "'Inter', sans-serif", color: C.textTertiary }}>
    ...
    <section className="px-6 py-20 text-center">
      <Link to="/contact" className="inline-flex items-center gap-3 px-10 py-4 rounded-full text-[12px] tracking-[2px] uppercase font-semibold transition-all duration-300 hover:scale-[1.03]"
        style={{ background: `linear-gradient(135deg, ${C.teal}, #6CBFC1)`, color: "#FFFFFF", boxShadow: `0 4px 30px rgba(74,165,168,0.35)`, fontFamily: "'Inter', sans-serif" }}>
