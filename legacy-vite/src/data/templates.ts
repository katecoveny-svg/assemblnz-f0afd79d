...
export const agentTemplates: Record<string, Template[]> = {
  ...
  marketing: [
    { icon: "social", title: "Social Media Strategy", description: "Build a 30-day social media content plan with post types, hooks, and scheduling", timeSaved: "~3 hours", prompt: "I need a 30-day social media strategy. Let's start — what industry are you in and which platforms do you use?" },
    { icon: "voice", title: "Brand Voice Guide", description: "Define your brand's tone, personality, and messaging pillars", timeSaved: "~2 hours", prompt: "Let's build your brand voice guide. First, describe your business and who your ideal customer is." },
    { icon: "email", title: "Email Campaign Sequence", description: "Create a nurture email sequence with subject lines and body copy", timeSaved: "~2 hours", prompt: "I'll help you create an email campaign sequence. What's the goal — lead nurture, onboarding, or re-engagement?" },
    { icon: "target", title: "Ad Copy Generator", description: "Generate LinkedIn and Instagram ad copy with hooks, CTAs, and targeting", timeSaved: "~1 hour", prompt: "Let's create some ad copy. What product or service are you promoting, and who's your target audience?" },
    { icon: "chart", title: "Content Calendar", description: "Plan a month of content across blog, social, email, and video", timeSaved: "~4 hours", prompt: "I'll build your content calendar. What channels do you publish on, and what are your key topics?" },
    { icon: "search", title: "SEO Content Brief", description: "Generate an SEO-optimised content brief with keywords and structure", timeSaved: "~1 hour", prompt: "Let's create an SEO content brief. What topic or keyword do you want to rank for?" },
    { icon: "newspaper", title: "Press Release Draft", description: "Write a media-ready press release for your announcement", timeSaved: "~1.5 hours", prompt: "I'll draft a press release. What's the news or announcement you want to share?" },
    { icon: "design", title: "Campaign Brief", description: "Create a creative brief for your next marketing campaign", timeSaved: "~2 hours", prompt: "Let's build a campaign brief. What's the campaign objective and who are you targeting?" },
  ],
  sales: [
  ],
  operations: [
  ...
  hr: [
    { icon: "document", title: "Employment Agreement", description: "Generate a compliant NZ employment agreement (permanent, fixed-term, or casual)", timeSaved: "~2 hours", prompt: "I need to create an employment agreement. Let's start — is this for a permanent, fixed-term, or casual employee?" },
    { icon: "calculator", title: "True Employment Cost Calculator", description: "Calculate the full cost of employing someone including KiwiSaver, ACC, and leave", timeSaved: "~30 min", prompt: "I need to calculate the true cost of employing someone. What's the proposed salary or hourly rate?" },
    { icon: "checkmark", title: "HR Compliance Scan", description: "Audit your employment practices against NZ employment law", timeSaved: "~3 hours", prompt: "I'd like an HR compliance scan. How many employees do you have and what industry are you in?" },
    { icon: "calendar", title: "Leave Entitlement Calculator", description: "Calculate leave entitlements under the Holidays Act 2003 (BAPS/ADP/OWP)", timeSaved: "~20 min", prompt: "I need to calculate leave entitlements. Tell me about the employee — start date, hours, and pay type." },
    { icon: "team", title: "Onboarding Checklist", description: "Create a comprehensive new employee onboarding checklist", timeSaved: "~1 hour", prompt: "I need an onboarding checklist for a new team member. What role are they starting in?" },
    { icon: "warning", title: "Performance Improvement Plan", description: "Draft a fair and legally compliant PIP", timeSaved: "~1.5 hours", prompt: "I need to create a Performance Improvement Plan. What are the performance concerns?" },
    { icon: "analysis", title: "Flight Risk Assessment", description: "Analyse retention risk factors for your team", timeSaved: "~1 hour", prompt: "I'd like to assess flight risk in my team. How many staff do you have and what's your current turnover rate?" },
    { icon: "lock", title: "Privacy Impact Assessment", description: "Assess employee data handling against Privacy Act 2020 (IPP 3A)", timeSaved: "~2 hours", prompt: "I need a privacy impact assessment for employee data. What HR systems do you use and what data do you collect?" },
    { icon: "clipboard", title: "Redundancy Process Guide", description: "Step-by-step guide to a fair redundancy process under NZ law", timeSaved: "~2 hours", prompt: "I need guidance on a redundancy process. What's the reason for the proposed restructure?" },
  ],
