...
@supports ((-webkit-background-clip:text) or (background-clip:text)){
  em.g{
    background:linear-gradient(100deg,var(--accent) 0%,var(--accent-lift) 42%,#FFFFFF 52%,var(--accent-lift) 62%,var(--accent-2) 100%);
...
.num .ghost{position:absolute;right:0;top:-30px;font-size:clamp(56px,9vw,116px);font-weight:900;
  line-height:1;letter-spacing:-.05em;color:transparent;-webkit-text-stroke:1px rgba(255,255,255,.075);
...
.glass{position:relative;overflow:hidden;background:rgba(12,12,14,.72)}
.verb{background:rgba(12,12,14,.66);backdrop-filter:blur(6px)}
.accept{background:linear-gradient(150deg,rgba(12,12,14,.90),rgba(12,12,14,.74))!important;backdrop-filter:blur(8px)}
.boundary,.unfin{background:rgba(12,12,14,.72)}
.glass::after{content:"";position:absolute;inset:0;pointer-events:none;opacity:0;transition:opacity .45s ease;
  background:radial-gradient(460px circle at var(--mx,50%) var(--my,50%),rgba(255,255,255,.10),transparent 62%)}
...
.mapband{position:relative;z-index:3;background:var(--map-bg);color:#141416;
  padding:82px 0 88px;margin:60px 0;box-shadow:0 -1px 0 rgba(255,255,255,.06),0 1px 0 rgba(255,255,255,.06)}
...
.mapScreen{background:linear-gradient(170deg,var(--map-scr) 0%,#0D0D10 100%);border-radius:14px;padding:13px 14px 15px;color:#F2F2F0;position:relative}
.msTop{display:flex;justify-content:space-between;align-items:center;font-size:9px;letter-spacing:.1em;color:rgba(255,255,255,.5);margin-bottom:11px}
...
.scratchCard{background:#101012;border-radius:20px;padding:22px;color:#F2F2F0}
...
.scAgain{margin-top:12px;background:transparent;border:1px solid rgba(242,242,240,.25);color:#F2F2F0;
