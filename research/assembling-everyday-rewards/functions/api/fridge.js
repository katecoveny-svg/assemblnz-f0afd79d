      ...
      low_or_out: {
        ...
        items: {
          ...
          properties: {
            ...
            box: {
              type: "object",
              description: "Rough bounding box of the item (or where it should be) as PERCENTAGES of the image: x/y = top-left, w/h = size, integers 0-100. Omit if you cannot place it.",
              required: ["x", "y", "w", "h"],
              properties: {
