...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // /journeys/evidence-receipt. Permanent so indexed and bookmarked
      // /mana-receipts URLs stop rendering the old experience.
      ...
      { source: "/kete/auaha", destination: "/agents/ensemble", permanent: true },
      { source: "/bundles/ensemble", destination: "/agents/ensemble", permanent: false },
      { source: "/bundles/ensemble/:path*", destination: "/agents/ensemble", permanent: false },
