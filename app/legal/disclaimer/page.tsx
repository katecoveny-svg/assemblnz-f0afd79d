        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-12 space-y-10 text-base leading-relaxed text-[color:var(--text-body)] md:text-[17px]">
            <SectionReveal delay={0.2}>
              <h2 className="font-display text-2xl font-light italic md:text-3xl">What assembl is.</h2>
              <p className="mt-3">
            ...
            <SectionReveal delay={0.25}>
              <h2 className="font-display text-2xl font-light italic md:text-3xl">What assembl is not.</h2>
              <p className="mt-3">
            ...
            <SectionReveal delay={0.3}>
              <h2 className="font-display text-2xl font-light italic md:text-3xl">How outputs are produced.</h2>
              <p className="mt-3">
            ...
            <SectionReveal delay={0.35}>
              <h2 className="font-display text-2xl font-light italic md:text-3xl">Reviewer responsibility.</h2>
              <p className="mt-3">
            ...
            <SectionReveal delay={0.4}>
              <h2 className="font-display text-2xl font-light italic md:text-3xl">Accuracy and limitations.</h2>
              <p className="mt-3">
            ...
            <SectionReveal delay={0.45}>
              <h2 className="font-display text-2xl font-light italic md:text-3xl">No professional relationship created.</h2>
              <p className="mt-3">
            ...
            <SectionReveal delay={0.5}>
              <h2 className="font-display text-2xl font-light italic md:text-3xl">Indemnity.</h2>
              <p className="mt-3">
            ...
            <SectionReveal delay={0.6}>
              <h2 className="font-display text-2xl font-light italic md:text-3xl">Questions.</h2>
              <p className="mt-3">
