 ...
 * next/font vars; display weights at Lato 700. Sits in the /dash Birdie chrome.
 * Palette: white + canary + charcoal.
 */

export const metadata: Metadata = {
  title: "dash. — Investor one-pager",
  description:
    ...
    <div className={styles.stage}>
      <div className={styles.page}>
        ...
        >
          ...
          >
            Every AI agent makes you wait. Dash turns that wait into value you
          ...
          >
            ...
            >
              ...
              >
                ...
                <div style={stepText}>
                  Agent runs; Dash shows one sponsored line under its status.
        ...
        >
          ...
          >
            Get paid for the wait. &middot; dash.assembl.co.nz
          </div>
        </div>
      </div>
    </div>
