...
/**
 * dash waitlist capture (pre-launch). Single email field → POST /api/dash-waitlist
 * with role 'earner' (the general "tell me when dash is live" bucket). That route
 ...
 *
 * dash is pre-launch — this is the only actionable thing on the page. Type stays
 * on the dash faces (Lato + Space Mono); no Cormorant on dash surfaces.
 *
  ...
  return (
    <form id="waitlist" onSubmit={onSubmit} style={{ maxWidth: 460 }}>
      ...
      <p style={{ marginTop: 12, fontSize: 12.5, lineHeight: 1.5, color: '#8a8678' }}>
        dash is pre-launch. We&rsquo;ll email you once — when it&rsquo;s live. No marketing, no spam.
