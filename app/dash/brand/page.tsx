...
export const metadata: Metadata = {
  ...
  description: "Dash by assembl — the reward layer for the wait. Palette, type, logo, voice and usage.",
  alternates: { canonical: "/dash/brand" },
};
    ...
    <div style={{ background: "#EDEAE2", padding: "40px 0", fontFamily: lato }}>
      ...
      >
            ...
            >
              <p style={{ margin: "0 0 16px" }}>
                ...
                <b style={{ color: "#3a3832" }}>
                  Dash turns that wait into value you keep:
                </b>{" "}
          ...
          >
            ...
            >
              ...
              <div
                style={{ fontSize: 14, color: "#56544b", lineHeight: 1.5 }}
              >
                Always <b>dash</b>, never Dash or DASH in the mark. Lato Black,
                tight tracking.
              </div>
            </div>
            <div
        ...
        >
          ...
          <div style={{ display: "flex", gap: 56 }}>
            <div style={{ flex: "none", width: 300 }}>
              ...
              >
                Dash is playful but never sleazy. Dog puns are welcome. Money
        ...
        >
          ...
          >
            Brand Guidelines v1.0 · dash.assembl.co.nz
          </div>
        </div>
      </div>
    </div>
