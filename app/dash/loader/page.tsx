...
export const metadata: Metadata = {
  title: 'dash. loader — get paid to wait',
  description:
    'Swap your default spinner for Dash. While you wait, a small NZ-brand line earns revenue — keep it, or donate it to SPCA NZ, Trees That Count or Foodbank NZ. Opt-in, Privacy Act 2020 native.',
  alternates: { canonical: '/dash/loader' },
};
      ...
      <div className={page.inner}>
        <section>
          ...
          <p className={page.lead}>
            Swap your default spinner for Dash. While you wait, a small NZ-brand line earns
