...
export const alt = 'dash — Get paid for the wait. The reward layer for the agentic wait, by assembl.';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

// Dash brand palette (locked): white + canary + charcoal. No black, no green.
...
export default async function DashOpengraphImage() {
  ...
  const latoText = 'dash Get paid for the wait. The reward layer for the agentic wait, by assembl.';
  const monoText = 'by assembl earn while your AI agent works · opt-in · NZ-built assembl.co.nz/dash';
