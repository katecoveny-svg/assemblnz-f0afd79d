...
/**
 * /dash/logo — Logo System, ported from the design handoff ("Dash - Logo
 ...
 * Sits inside the /dash Birdie chrome. Palette: white + canary + charcoal.
 */

export const metadata: Metadata = {
  title: 'dash. — Logo System',
  description:
    'The Dash wordmark, lockups, reversed/canary variants, app icon, the dash-line motif and construction spec.',
  alternates: { canonical: '/dash/logo' },
};
