...
(function () {
  ...
  shadow.innerHTML = '<style>' +
    ...
    '<div class="aw-foot"><a target="_blank" rel="noreferrer" href="'+host+'/workflows/'+slug+'">Open full result on assembl.co.nz</a></div>' +
    '</section>';
