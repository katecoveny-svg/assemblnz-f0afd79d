 ...
 *
 * NOTE: the brief asks for this consumer demo to live ON the /assembling landing
 * (app/assembling/page.tsx). That path was owned by the Beat→Dash rename
 * (PR #424), so the live demo ships here at /assembling/loader to avoid clobbering
