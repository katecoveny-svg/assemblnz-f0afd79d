...
export const metadata: Metadata = {
  title: 'Assembling privacy · assembl',
  description:
    'How Assembling by assembl handles data under the Privacy Act 2020. No prompt or content collection, salted IP hashing, Sydney data residency, and retention periods.',
  alternates: { canonical: '/assembling/privacy' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Assembling privacy · assembl',
    description:
      'How Assembling by assembl handles data under the Privacy Act 2020 — what we collect, what we never do, salted IP hashing and Sydney residency.',
    type: 'website',
    siteName: 'assembling. by assembl',
    url: '/assembling/privacy',
    locale: 'en_NZ',
    images: [
      { url: '/images/dash/og-image.png', width: 1200, height: 630, alt: 'Assembling privacy · assembl' },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Assembling privacy · assembl',
    description: 'How Assembling by assembl handles data under the Privacy Act 2020.',
  ...
  return (
    <section className={styles.legal}>
      ...
      <div className={styles.legalBody}>
        <p>
          <strong>Assembling by assembl</strong> is built to be native to the Privacy Act 2020. This
          policy explains what we collect, what we deliberately do not, and how we look after it.
          ASSEMBL NZ LIMITED is the agency responsible for personal information handled through Assembling.
        ...
        <p>
          The Assembling SDK is designed so it has no way to read the things that matter most. We never
        ...
        <p>
          Assembling&rsquo;s data is hosted in <strong>Sydney, Australia</strong> on our infrastructure
        ...
        <p>
          ...
          about you. Because Assembling stores no raw identifiers and no content, the information we can
