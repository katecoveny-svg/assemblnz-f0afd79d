...
export const metadata: Metadata = {
  title: 'assembling. loader — three-mode demo',
  description:
    'The Assembling Loader in all three modes — consumer opt-in, whitelabel, and publisher — cycling through idle, processing, success and error.',
  robots: { index: false },
};
    ...
    <main className={`${page.shell} ${dashFontVars}`} data-dash="">
      <header className={page.header}>
        ...
        <h1 className={page.title}>
          assembling<span className={page.dot}>.</span> loader
        </h1>
