...
export const metadata: Metadata = {
  title: 'Assembling rewards · assembl',
  description:
    'Your Assembling balance accrues while AI works, then you redeem it. Charity is live at launch; KiwiSaver, Airpoints, Everyday Rewards, power-bill credit and more roll out as partner integrations land. Never cash-per-wait; cash is a later, gated tier.',
  alternates: { canonical: '/assembling/rewards' },
  openGraph: {
    title: 'Assembling rewards · assembl',
    description:
    ...
    url: '/assembling/rewards',
    locale: 'en_NZ',
    images: [
      { url: '/images/dash/og-image.png', width: 1200, height: 630, alt: 'Assembling rewards · assembl' },
    ],
  },
  twitter: {
...
const HOW = [
  {
    n: 1,
    title: 'It accrues',
    body: 'Every qualifying wait adds a few cents to your Assembling balance, server-side. No money moves per wait — that keeps it honest and fee-free.',
  },
  {
    n: 2,
      ...
      <section className="section">
        <div className="wrap">
          ...
          <p className="lead" style={{ marginTop: 18, maxWidth: 620 }}>
            Assembling pays you in rewards, not cash-per-wait. Your balance builds while AI works, then you
        ...
        <div className="wrap">
          <div className="howPanel" style={{ padding: 'clamp(28px, 5vw, 56px)' }}>
            ...
            <p className="body" style={{ marginTop: 24, color: 'var(--muted)', maxWidth: 680 }}>
              ...
              recipient KYC-verified — paying a few cents per wait is impossible. So Assembling is a
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="wrap">
          ...
          <div className="heroCta" style={{ marginTop: 36 }}>
            <Link href="/assembling/wallet" className="btn btn--primary btn--lg">
              See your wallet <ArrowRight aria-hidden />
            </Link>
            <Link href="/assembling#flagship" className="btn btn--ghost btn--lg">
              See how it works
            </Link>
          </div>
        </div>
