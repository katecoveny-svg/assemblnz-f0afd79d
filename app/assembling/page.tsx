...
/**
 * /assembling — the Birdie Direction marketing home.
 *
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'assembling — Get paid for the wait.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'assembling — Get paid for the wait.',
      },
    ],
  },
  twitter: {
    ...
    <div style={{ background: '#FFFFFF', color: '#3a3832' }}>
      ...
      >
        ...
        >
          ...
          <img
            src={MASCOT}
            alt="Assembling — the dachshund mascot"
            className="bd-floaty"
            style={{
              position: 'relative',
              width: '100%',
      ...
      >
        <div className="bd-reveal" style={{ textAlign: 'center', marginBottom: 56 }}>
          ...
          >
            Assembling shows one sponsored line and a loader under your agent&apos;s status. The longer it
