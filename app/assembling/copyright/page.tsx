...
export const metadata: Metadata = {
  title: 'Assembling by assembl — Copyright & Trademarks',
  description:
    'Copyright, trademark and intellectual-property terms for Assembling by assembl, including the proprietary SDK and how to report infringing content.',
  alternates: { canonical: '/assembling/copyright' },
  ...
  return (
    <section className={styles.legal}>
      ...
      <div className={styles.legalBody}>
        <h2>1. Ownership</h2>
        <p>
          The <strong>Assembling by assembl</strong> network, this website, the Assembling brand, and all
        ...
        <h2>2. Trademarks</h2>
        <p>
          <strong>assembl</strong>, <strong>Assembling by assembl</strong>, the assembl and Assembling
          ...
          reference (for example, &ldquo;our tool uses Assembling by assembl&rdquo;) is permitted where it
        ...
        <p>
          ...
          purpose of serving Assembling inventory under our{' '}
          <a href="/assembling/terms">Terms of Service</a>. Except to the extent permitted by law, you may
        ...
        <p>
          ...
          responsible for ensuring you hold the rights to anything you submit to Assembling.
        </p>
        ...
        <p>
          ...
          hosted through Assembling infringes your copyright, send a notice to our designated agent with:
        </p>
        <ul>
        ...
        <p>
          ...
          <a href="mailto:assembl@assembl.co.nz?subject=Assembling%20by%20assembl%20%E2%80%94%20copyright%20notice">
