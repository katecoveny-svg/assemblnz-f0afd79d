...
export const metadata: Metadata = {
  title: 'Assembling for AI builders · assembl',
  description:
    'Your AI agent makes people wait while it works. Assembling turns that wait into a reward your users keep — charity at launch, with KiwiSaver, Airpoints and more rolling out as partners come on. Opt-in, white-label, NZ-built, assembl-governed.',
  alternates: { canonical: '/assembling/for-ai-builders' },
  openGraph: {
    title: 'Assembling for AI builders · assembl',
    description:
    ...
    url: '/assembling/for-ai-builders',
    locale: 'en_NZ',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Assembling for AI builders · assembl',
      },
    ],
  },
  twitter: {
          ...
          >
            <div>
              ...
              <p className="lead" style={{ marginTop: 18, maxWidth: 540 }}>
                Your agent makes people wait while it runs. Assembling turns that wait into a reward they
              ...
              <div className="heroCta" style={{ marginTop: 28 }}>
                <Link href="/assembling/sdk" className="btn btn--primary btn--lg">
                  Read the SDK <ArrowRight aria-hidden />
                </Link>
                <Link href="/assembling/rewards" className="btn btn--ghost btn--lg">
                  See the rewards
                </Link>
              </div>
            </div>
          ...
          >
            <div>
              ...
              <p className="body" style={{ marginTop: 14, color: 'var(--muted)', maxWidth: 460 }}>
                Point Assembling at the screen you already show while the agent runs. It returns one
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="wrap">
          ...
          <p className="body" style={{ maxWidth: 560, color: 'var(--muted)', fontSize: 17 }}>
            Run Assembling in your own UI and wordmark — the wait still pays your users, and you ship a
