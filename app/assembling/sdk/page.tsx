...
export const metadata: Metadata = {
  title: 'Assembling SDK · assembl',
  description:
    'The Assembling SDK reference — add a reward layer to your agent’s working state in one call. In early access: request a key to get started.',
  alternates: { canonical: '/assembling/sdk' },
  openGraph: {
    title: 'Assembling SDK · assembl',
    description:
      'The Assembling SDK reference — add a reward layer to your agent’s working state in one call. In early access.',
    type: 'website',
    siteName: 'assembling. by assembl',
    url: '/assembling/sdk',
    locale: 'en_NZ',
    images: [
      { url: '/images/dash/og-image.png', width: 1200, height: 630, alt: 'Assembling SDK · assembl' },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Assembling SDK · assembl',
    description: 'The Assembling SDK reference. In early access — request a key.',
      ...
      >
        ...
        <div className="sdk-pad" style={{ padding: '34px 48px 10px' }}>
          <p style={{ margin: 0, fontSize: 17, lineHeight: 1.6, color: '#56544b' }}>
            Add a reward layer to your agent&apos;s working state in one call. Assembling renders a
        ...
        <div className="sdk-pad" style={{ padding: '24px 48px 10px' }}>
          ...
          <Code
            ...
            tokens={[
              ['POST /your/webhook  (signed: Assembling-Signature)', 'c'], '\n',
