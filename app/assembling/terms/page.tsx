...
export const metadata: Metadata = {
  title: 'Assembling terms · assembl',
  description:
    'The terms that govern Assembling by assembl, the NZ in-product ad network. Revenue split, advertising standards, governing law and liability.',
  alternates: { canonical: '/assembling/terms' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Assembling terms · assembl',
    description:
      'The terms that govern Assembling by assembl — revenue split, advertising standards, governing law and liability.',
    type: 'website',
    siteName: 'assembling. by assembl',
    url: '/assembling/terms',
    locale: 'en_NZ',
    images: [
      { url: '/images/dash/og-image.png', width: 1200, height: 630, alt: 'Assembling terms · assembl' },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Assembling terms · assembl',
    description: 'The terms that govern Assembling by assembl, the NZ in-product ad network.',
  ...
  return (
    <section className={styles.legal}>
      ...
      <p className={styles.legalMeta}>
        Assembling by assembl · ASSEMBL NZ LIMITED · last updated 17 June 2026
      </p>

      <div className={styles.legalBody}>
        <p>
          These terms govern your use of <strong>Assembling by assembl</strong> (&ldquo;Assembling&rdquo;,
          &ldquo;we&rdquo;, &ldquo;us&rdquo;), the New Zealand in-product advertising network
          operated by ASSEMBL NZ LIMITED, a company registered in Aotearoa New Zealand. Assembling is an
        ...
        <p>
          By installing the Assembling SDK, running a Assembling campaign, or otherwise using the network, you
        ...
        <h2>1. What Assembling does</h2>
        <p>
          Assembling serves a single, calm line of sponsored New Zealand brand text inside the
        ...
        <p>
          If you install the SDK and serve Assembling inventory, you are a publisher. The standard split
        ...
        <p>
          All Assembling advertising must comply with the Advertising Standards Authority (NZ) codes,
        ...
        <ul>
          ...
          <li>Do not place Assembling inventory in unlawful, misleading or harmful surfaces.</li>
        </ul>

        <h2>6. Privacy</h2>
        <p>
          Assembling is built to be Privacy Act 2020 native. The SDK never reads prompts, content, code,
          files or user data. How we handle the limited data we do process is set out in our{' '}
          <a href="/assembling/privacy">Privacy Policy</a>, which forms part of these terms.
        </p>

        <h2>7. Liability</h2>
        <p>
          Nothing in these terms limits liability that cannot be limited by law, including under the
          Consumer Guarantees Act 1993 where it applies. Where you acquire Assembling for the purposes of
        ...
        <p>
          ...
          <strong>
            our total aggregate liability to you arising out of or in connection with Assembling is capped
            at the total amounts paid to or by you through Assembling in the three (3) months immediately
            before the event giving rise to the claim
          </strong>
          ; and neither party is liable for indirect, consequential, or loss-of-profit damages. Assembling
