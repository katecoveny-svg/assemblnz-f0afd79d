...
export default function PricingPage() {
  return (
    <main className="bg-[color:var(--assembl-paper)] text-[color:var(--text-primary)]">
      <section className="relative overflow-hidden border-b border-[rgba(35,33,31,0.08)] py-24 lg:py-32">
      ...
      <section className="border-t border-[rgba(212,168,83,0.36)] py-24 lg:py-32">
