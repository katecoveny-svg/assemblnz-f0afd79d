  ...
  return (
    <main className="min-h-screen bg-[color:var(--assembl-paper)] text-[color:var(--text-primary)]">
      <header className="mx-auto max-w-[1180px] px-5 pt-8 md:px-10 md:pt-14">
        ...
        <p className="mt-3 font-mono text-[10.5px] uppercase tracking-[0.16em] text-[color:var(--text-secondary)]">
        ...
        <div className="rounded-[3px] border border-[color:var(--assembl-cloud)] bg-[color:var(--assembl-paper)] p-6">
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div className="flex flex-col gap-1">
              <div className="font-mono text-[10.5px] uppercase tracking-[0.2em] text-[color:var(--text-secondary)]">
      ...
      <section className="mx-auto max-w-[1180px] px-5 pb-16 pt-10 md:px-10 md:pb-24">
        <div className="mb-4 font-mono text-[10.5px] uppercase tracking-[0.22em] text-[color:var(--text-secondary)]">
          ...
          {AGENTS.map((agent) => (
            <div key={agent.slug} className="flex flex-col items-center gap-3">
              ...
              <div className="text-center">
                ...
                <div className="mt-0.5 font-mono text-[9.5px] tracking-[0.04em] text-[color:var(--text-secondary)]">
                  {agent.name}
                </div>
              </div>
            </div>
