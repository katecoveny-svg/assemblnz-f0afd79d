  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <button
        ...
        onClick={handle}
        disabled={isPending}
        className="inline-flex h-10 items-center rounded-[2px] border border-[color:var(--assembl-cloud)] bg-white px-5 font-mono text-[12px] uppercase tracking-[0.18em] text-[color:var(--text-primary)] hover:bg-[color:var(--assembl-paper)] disabled:opacity-50"
      >
