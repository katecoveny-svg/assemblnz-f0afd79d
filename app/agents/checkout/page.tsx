...
import { getAgentPlan } from '@/lib/billing/agent-pricing';
 ...
 * the picker. The agent registry stays server-side (it carries locked prompts);
 * we pass only a slim, prompt-free projection to the client picker.
 */
