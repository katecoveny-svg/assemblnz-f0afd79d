    ...
    <div className="mk-root flex h-[100dvh] flex-col" style={{ backgroundColor: PALETTE.cream }}>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span
            className={orb.orb}
            style={{ width: 40, height: 40, background: 'radial-gradient(circle at 32% 24%, #ffffff 0%, #cfd1cf 42%, #51585b 100%)' }}
            aria-hidden
          >
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 py-6 md:px-6">
        <div className="mx-auto flex max-w-2xl flex-col gap-4">
          ...
          {paywall ? (
            ...
            >
              {agent.name} could not prepare a draft just now. Please try once more, or return to the agent page.
            </div>
          ) : null}
