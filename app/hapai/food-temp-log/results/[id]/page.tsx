...
export default async function FoodAuditResultPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-[color:var(--assembl-paper)] px-6 py-10 text-[#23211F] print:bg-white md:px-12 md:py-14">
      <div className="mx-auto max-w-[980px]">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4 print:hidden">
          <Link href="/hapai/food-temp-log" className="font-mono text-[11px] uppercase tracking-[0.18em] text-[#6B6661] hover:text-[#AC5838]">
        ...
        <article className="rounded-[16px] border border-[rgba(35,33,31,0.10)] bg-white p-6 shadow-[0_24px_80px_rgba(35,33,31,0.08)] print:border-0 print:shadow-none md:p-9">
          <p className="font-mono text-[11px] uppercase tracking-[0.28em] text-[#AC5838]">Food Act 2014 · daily record</p>
          ...
          <section className="mt-8 border-t border-[rgba(35,33,31,0.10)] pt-6">
            <div className="flex items-start gap-3">
              <ClipboardList className="mt-1 h-5 w-5 text-[#AC5838]" aria-hidden />
              <div>
