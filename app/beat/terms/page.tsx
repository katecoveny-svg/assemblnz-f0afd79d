...
export const metadata: Metadata = {
  title: 'Beat by assembl — Terms of Service',
  description:
    'The terms that govern Beat by assembl, the NZ in-product ad network. Revenue split, advertising standards, governing law and liability.',
  alternates: { canonical: '/beat/terms' },
  robots: { index: true, follow: true },
};

export default function BeatTermsPage() {
  return (
    <section className={styles.legal}>
      <h1 className={styles.legalTitle}>Terms of Service</h1>
      <p className={styles.legalMeta}>
        Beat by assembl · ASSEMBL NZ LIMITED · last updated 17 June 2026
      </p>

      <div className={styles.legalBody}>
        <p>
          These terms govern your use of <strong>Beat by assembl</strong> (&ldquo;Beat&rdquo;,
          &ldquo;we&rdquo;, &ldquo;us&rdquo;), the New Zealand in-product advertising network
          operated by ASSEMBL NZ LIMITED, a company registered in Aotearoa New Zealand. Beat is an
        ...
        <p>
          By installing the Beat SDK, running a Beat campaign, or otherwise using the network, you
        ...
        <h2>1. What Beat does</h2>
        <p>
          Beat serves a single, calm line of sponsored New Zealand brand text inside the
        ...
        <p>
          If you install the SDK and serve Beat inventory, you are a publisher. The standard split
        ...
        <p>
          All Beat advertising must comply with the Advertising Standards Authority (NZ) codes,
        ...
        <ul>
          ...
          <li>Do not place Beat inventory in unlawful, misleading or harmful surfaces.</li>
        </ul>

        <h2>6. Privacy</h2>
        <p>
          Beat is built to be Privacy Act 2020 native. The SDK never reads prompts, content, code,
          files or user data. How we handle the limited data we do process is set out in our{' '}
          <a href="/beat/privacy">Privacy Policy</a>, which forms part of these terms.
        </p>

        <h2>7. Liability</h2>
        <p>
          Nothing in these terms limits liability that cannot be limited by law, including under the
          Consumer Guarantees Act 1993 where it applies. Where you acquire Beat for the purposes of
        ...
        <p>
          ...
          <strong>
            our total aggregate liability to you arising out of or in connection with Beat is capped
            at the total amounts paid to or by you through Beat in the three (3) months immediately
            before the event giving rise to the claim
          </strong>
          ; and neither party is liable for indirect, consequential, or loss-of-profit damages. Beat
