...
export const metadata: Metadata = {
  title: 'Beat by assembl — Privacy Policy',
  description:
    'How Beat by assembl handles data under the Privacy Act 2020. No prompt or content collection, salted IP hashing, Sydney data residency, and retention periods.',
  alternates: { canonical: '/beat/privacy' },
  robots: { index: true, follow: true },
};

export default function BeatPrivacyPage() {
  return (
    <section className={styles.legal}>
      ...
      <div className={styles.legalBody}>
        <p>
          <strong>Beat by assembl</strong> is built to be native to the Privacy Act 2020. This
          policy explains what we collect, what we deliberately do not, and how we look after it.
          ASSEMBL NZ LIMITED is the agency responsible for personal information handled through Beat.
        ...
        <p>
          The Beat SDK is designed so it has no way to read the things that matter most. We never
        ...
        <p>
          Beat&rsquo;s data is hosted in <strong>Sydney, Australia</strong> on our infrastructure
        ...
        <p>
          ...
          about you. Because Beat stores no raw identifiers and no content, the information we can
