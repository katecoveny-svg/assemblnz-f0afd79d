...
export const alt = 'Beat by assembl — get paid for the wait. Publishers keep 55%.';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

// Beat microsite palette (locked).
const CREAM = '#FAF7F2';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 10 }}>
          <span style={{ fontFamily: display, fontSize: 34, fontWeight: 600, color: INK }}>Beat</span>
          <span
            style={{
              fontSize: 15,
              fontWeight: 500,
        ...
        >
          ...
          <span style={{ display: 'flex', letterSpacing: '0.06em' }}>assembl.co.nz/beat</span>
        </div>
      </div>
    ),
