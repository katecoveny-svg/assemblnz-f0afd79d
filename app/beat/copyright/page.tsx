...
export const metadata: Metadata = {
  title: 'Beat by assembl — Copyright & Trademarks',
  description:
    'Copyright, trademark and intellectual-property terms for Beat by assembl, including the proprietary SDK and how to report infringing content.',
  alternates: { canonical: '/beat/copyright' },
  robots: { index: true, follow: true },
};

export default function BeatCopyrightPage() {
  return (
    <section className={styles.legal}>
      ...
      <div className={styles.legalBody}>
        <h2>1. Ownership</h2>
        <p>
          The <strong>Beat by assembl</strong> network, this website, the Beat brand, and all
        ...
        <h2>2. Trademarks</h2>
        <p>
          <strong>assembl</strong>, <strong>Beat by assembl</strong>, the assembl and Beat
          ...
          reference (for example, &ldquo;our tool uses Beat by assembl&rdquo;) is permitted where it
          is accurate and not misleading.
        </p>

        <h2>3. The SDK is proprietary</h2>
        <p>
          The <strong>@assembl/beat-sdk</strong> and any related libraries are{' '}
          <strong>proprietary software</strong>, licensed — not sold — to publishers for the sole
          purpose of serving Beat inventory under our{' '}
          <a href="/beat/terms">Terms of Service</a>. Except to the extent permitted by law, you may
        ...
        <p>
          ...
          responsible for ensuring you hold the rights to anything you submit to Beat.
        </p>
        ...
        <p>
          ...
          hosted through Beat infringes your copyright, send a notice to our designated agent with:
        </p>
        <ul>
        ...
        <p>
          ...
          <a href="mailto:assembl@assembl.co.nz?subject=Beat%20by%20assembl%20%E2%80%94%20copyright%20notice">
