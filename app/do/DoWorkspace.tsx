...
export function DoWorkspace({ initialBrief = '', initialTask = 'reply', embedded = false }: { initialBrief?: string; initialTask?: DoTask; embedded?: boolean }) {
