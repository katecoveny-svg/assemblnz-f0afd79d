...
export function DoBuilder({ initialBrief = '', initialTask = 'reply', embedded = false }: { initialBrief?: string; initialTask?: DoTask; embedded?: boolean }) {
  ...
  return <div className="dob">
    <p><a href="/do/bills" target="_blank" rel="noopener noreferrer">Bills &amp; budget ↗</a> · <a href="/do/family" target="_blank" rel="noopener noreferrer">School admin from Gmail · pilot setup ↗</a></p>
