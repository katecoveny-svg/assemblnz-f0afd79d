...
function BuilderJobCard({ record }: { record: DurableJobRecord }) {
  return <article className={styles.card}>
    ...
    <p className={styles.note}>Authority: {record.job.authority}. Acceptance receipts are available; execution success is not claimed until a build produces evidence.</p>
...
export default async function DoOfficePage() {
  ...
  return <div className={styles.page}>
    ...
    <main className={styles.main}>
      <section className={styles.intro}><div><p className={styles.eyebrow}>your digital workforce</p><h1>give the work.<br />see it move.</h1></div><p className={styles.introCopy}>Builder DO gives the team work. The Office shows what is moving, what needs your yes, and what just finished. Signed-in Builder jobs now land in your personal Office workspace with acceptance receipts.</p></section>
