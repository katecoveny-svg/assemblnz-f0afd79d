...
import { HAPPY_TAILS_TENANT } from '@/lib/customers/happy-tails/genome';
import { INVITE_COOKIE } from '@/lib/demo-invites/crypto';

export type EditFactResult = { ok: boolean; message?: string };

/**
 * Write one Happy Tails Genome fact — the ripple made user-editable.
 *
...
export async function updateGenomeFactAction(
  ...
  revalidatePath('/customers/happy-tails/ops');
  return { ok: true };
}
