...
function appendWatermark(html: string) {
  return (
    ...
    `<span><span style="font-family:'Fraunces',Georgia,serif;font-style:italic;text-transform:none;letter-spacing:0;font-size:14px;color:#3A3832;">assembl</span> · study helper</span>` +
