...
/** Files shipped in the Chrome DO zip — keep in sync with scripts/package-do-downloads.mjs */
...
Use **Sign in** / **Meeting notes** in the side panel. Those open a normal assembl browser tab so OAuth can finish. After sign-in, return to the side panel and click **Refresh builder** if needed.
...
Install guide: ${origin}/do/install#mac
`,
      );
    } else {
