...
import type { CompileRequest, ConnectorChoice, PageContext } from '@/apps/do/shared/types';
...
const CONNECTORS: readonly ConnectorChoice[] = ['sap', 'email', 'calendar', 'xero', 'akahu', 'hook-later'];
...
function connectorChoice(value: unknown): ConnectorChoice {
  ...
  return CONNECTORS.includes(value as ConnectorChoice) ? value as ConnectorChoice : 'hook-later';
}
