...
export const metadata: Metadata = {
  ...
  description:
    'Independent concept: the wait is the earn event. Phone Dollars stamp into One Wallet while you wait — with an Evidence receipt as wait proof. Not a current One NZ offer or partnership.',
