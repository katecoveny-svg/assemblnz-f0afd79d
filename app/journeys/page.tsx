        ...
        <div style={{ display: 'grid', gap: '1rem', marginTop: '2.5rem' }}>
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap' }}>
              ...
              >
                Operator desk DEMO · live session
              </h2>
              <span
                style={{
                  fontFamily: 'var(--font-mono, monospace)',
            ...
            <p style={{ margin: '0.6rem 0 0', color: 'var(--a-text-dim, #556)', lineHeight: 1.55 }}>
              Live Operator craft for wait→earn, Evidence receipts, approvals and agents. Auto-advancing
              DEMO session — not money moved, not a trading desk.
            </p>
          </Link>
