...
| Public atelier journey | existing / hardened | `components/site/assembl-the-work/AssemblWorldHero.tsx`, `app/preview/do-world/WorldScene.tsx` | public home and world study | hero resilience tests + browser checks in `docs/reviews/site-repair/checks/` | one Blender scene, complete DOM/static loop, explicit context-loss fallback, offscreen unmount |
