...
const CAPS = [
  { Icon: IconMenuPOS, label: "Menu & POS" },
  { Icon: IconFoodSafety, label: "Food Safety" },
  { Icon: IconGuestMemory, label: "Guest Memory" },
  { Icon: IconReservation, label: "Reservations" },
  { Icon: IconStaffRoster, label: "Staff Roster" },
  { Icon: IconRevenue, label: "Revenue AI" },
];
        ...
        {[0, 60, 120, 180, 240, 300].map((deg, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              background: i % 3 === 0 ? AURA_ACCENT : i % 3 === 1 ? BRAND.purple : BRAND.cyan,
              boxShadow: `0 0 ${dotPulse * 2}px ${i % 3 === 0 ? AURA_ACCENT : i % 3 === 1 ? BRAND.purple : BRAND.cyan}70`,
            }} />
          );
        })}
        <svg width={700} height={700} style={{ position: "absolute", top: 0, left: 0 }}>
          {[0, 60, 120, 180, 240, 300].map((deg, i) => {
            ...
            return <line key={i}
              ...
              stroke={`${AURA_ACCENT}20`} strokeWidth={1} />;
          })}
        </svg>
      </div>
      ...
      <Sequence from={0}>
        <div style={{
          ...
          <div style={{
            ...
            border: `2px solid ${AURA_ACCENT}35`,
            boxShadow: `0 0 ${avatarGlow}px ${AURA_ACCENT}40, 0 16px 48px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.12)`,
          ...
          {CAPS.map((cap, i) => {
            ...
            return (
              <div key={i} style={{
                ...
                <cap.Icon size={28} color={AURA_ACCENT} glow={iconGlow} />
